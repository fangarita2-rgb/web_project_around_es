...
const profileAvatarButton = document.querySelector<HTMLButtonElement>(".profile__avatar-button")!;
...
const editAvatarForm = document.querySelector<HTMLFormElement>("#edit-avatar-form")!;
...
profileEditButton.addEventListener("click", () => {
  ...
  const nameInput = editProfileForm.querySelector<HTMLInputElement>("#profile-name-input")!;
  const descriptionInput = editProfileForm.querySelector<HTMLInputElement>("#profile-description-input")!;
